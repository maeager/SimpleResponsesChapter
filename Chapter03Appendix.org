...
#Dominic Mazzoni for the real-time resample library interface 
...
#+BEGIN_LaTeX
  \begin{figure}[htb] 
  \centering
  \resizebox{0.9\textwidth}{!}{\includegraphics{../SimpleResponsesChapter/gfx/Praxis_123}\includegraphics{../SimpleResponsesChapter/gfx/Praxis_456}}
