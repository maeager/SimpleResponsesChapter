...
chapter is called [[latex:progname][cnstellate]] and is implemented in [[latex:progname][NEURON]], [[latex:progname][NMODL]] and [[latex:progname][C]]
source code.

I acknowledge the contribution M.S.A. Zilany, Laurel Carney, Ian Bruce
and colleagues for their work on the AN model.  Also, for their
investigation of membrane currents in \CN neurons, I would like to
thank  Jason Rothman and Paul Manis. 
