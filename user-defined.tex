...
\hyphenation{cross-talk au-di-tory adap-t-a-tion phe-nom-en-o-lo-g-i-cal
  ...
  In-tra-cel-lu-lar neur-ronsin-tra-cel-lu-lar in-ves-ti-ga-tion se-quen-tial
  de-ter-min-ed cat-e-gor-is-ed im-me-di-ate sen-si-tiv-ity bicu-cu-line
  mul-ti-ple in-hib-it-ory Need-ham com-mis-sural path-way re-cip-ro-cal
  fre-quency po-si-tion func-tion de-lay prepa-ra-tions iso-lated oct-o-pus
  in-sen-si-tive Chop-per im-preg-na-tion phys-i-o-log-i-cal ef-fect GABAer-gic
  in-puts on-set chop-pers pri-mar-ily Caspary gen-er-ate ar-ray gaus-sian
  ran-dom num-bers Pro-ce-dure au-dio-gram in-ter-po-late}
%%
