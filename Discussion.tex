...
\todo[inline]{Discuss the relevance of creating the CN stellate model,
...
\medskip{} 
\subsection{Verification of CN cell models}
\subsubsection{Golgi cell model}

\todo[inline]{Discuss the Golgi cell optimisation.  Is the filter-based
  approach effective at meeting the goal of simulating data from
GhoshalKim:1997. The Golgi cell model optimised in section~\ref{sec:GolgiCellModel} reproduces the experimental data of a single
unit in the marginal shell of the \VCN \citep{GhoshalKim:1997}.}

\medskip{}
\subsubsection{D-stellate cell model}

\todo[inline]{Discuss the DS cell model optimisation.  What were the reasons for
...
\todo[inline]{Discuss the TV cell optimisation. Is the goal of replicating wide-band
...
\subsection{Limitations of the CN stellate microcircuit model}

\todo[inline]{AM coding in model is not verified by \citet{ZilanyBruce:2006} model,
...
\todo[inline]{Probability distribution of delay (within cell-to-cell connection) not included.}

\medskip{}

\todo[inline]{Probability of AP-to-synaptic release ratio not included (Liley assumption of 1\% vessicle release in cortical buttons.) }
