...
{\rule{1em}{0em}\vspace*{-5.5ex}\begin{equation*}
      \begin{array}{r@{\;=\;}ll}
               \mathbf{w}_{L,H}                &                w_{LSR,HSR \to GLG}  \mathcal{N}(i,\sigma)                & , i=\text{channel position}, \sigma^2=\sLSRGLG \\ 
                  \alpha(t)                    &            \left( t  \exp(\frac{-t}{\Gtau}) \right)           &  \text{synapto-dendritic filter with unit area}  \dag \\
...
\vspace*{-2.5ex}\rule{1em}{0em}}                  \\\hline
