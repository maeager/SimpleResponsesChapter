...
%        \textbf{Input Stimulus}         & Five mask and recovery click pairs separated by 50 msec\\\hline
%         \textbf{Measurements}          & PSTH sampled at each click for 2 msec to measure recovery from masking clicks\\\hline
\end{tabularx}
\vspace{1ex}
% - B -----------------------------------------------------------------------------
\noindent%
...
$\tau_{\rm GABA-2}$,
      \DS \gleak    \\\hline
% \textbf{Measurements}   &  Spiking output of DS unit, in channel 50, from 25 repetitions and collected in a PSTH.  The PSTH was sampled at each click for 2 msec to measure click recovery. Idle times were recorded for spontaneous activity and level of ANF excitation.\\\hline
% PSTHs were generated from 25 stimulus repetitions. Each response to a click is measured for a period of 2 msec.  The sample period was delayed by 4 msec, an estimate of the auditory delay and minimum first spike latency for the DS unit.  The unit used   in the optimisation has a CF = 5.8~kHz (channel no. 50).\\ \hline
