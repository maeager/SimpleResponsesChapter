...
\VCN~\citep[Fig.~\ref{fig:CNdiagram}]{Mugnaini:1985,FerragamoGoldingEtAl:1998}. \yellownote{GCD  is also called marginal shell in gerbils.}
...
\end{figure}
\yellownote{Inclusion of Ghoshal figure needs permission, fill in
  caption}
