...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\graphicspath{{../figures/}{./gfx/}{/media/data/Work/cnstellate/golgi/}{/media/data/Work/cnstellate/ResponsesNoCompression/}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[ht!]
  ...
  \yellownote{Inclusion of Ghoshal figure needs permission, fill in caption}}\label{fig:GolgiKimFig2}
\end{figure}
...
%     $\alpha$ is the synaptic and dendritic smoothing function.
 ...
 % \yellownote{TODO: expand para, include fig ref} Choosing neural model:
 % HH-type or Poisson - Problem of monotonic excitation at low levels - Spread
 % of ANF to GCD ARE broader than core VCN - are we spoiling the broth too
 % early?
...
\begin{figure}[htb]
  ...
  \resizebox{\textwidth}{!}{\includegraphics{./gfx/GolgiRateLevel_result2.eps}\hspace{5pt}\includegraphics{./gfx/GolgiRateLevel_result.eps}} \\
...
A more detailed optimisation routine with 22 levels and an enhanced
...
\yellownote{We are satisfied with the golgi cell response, now show a plot of simple responses of a generic cell in the centre of the network.}
...
\begin{figure}[h]
     \centering
\resizebox{0.95\textwidth}{!}{\includegraphics{RateLevel/G_ratelevel.eps} \includegraphics{RateLevel/response_area.3.eps}}
\resizebox{0.95\textwidth}{!}{\includegraphics{NoiseRateLevel/G_ratelevel.eps} \includegraphics{MaskedResponseCurve/psthsingle5810.3.eps}}
\caption{Response of optimised golgi cell model at the centre of the network (CF=5.8~kHz). }\label{fig:Golgi_verification}
   \end{figure}
