...
\begin{figure}[htb]
  \centering
  % \resizebox{3.5in}{!}{\includegraphics{NoFigure}} \\
  \resizebox{0.6\textwidth}{!}{\includegraphics{GolgiRateLevel_result.eps}} \\
...
\begin{figure}[htb]
  ...
  \resizebox{0.95\textwidth}{!}{\includegraphics{ResponsesNoComp/G_ratelevel_combined.eps}\includegraphics{ResponsesNoComp/RateLevel/psthsingle90.3.eps}}\\
  \figfont{C}\hfill\figfont{D}\hfill\\
  \resizebox{0.95\textwidth}{!}{\includegraphics{ResponsesNoComp/RateLevel/response_area.3.eps}%
\includegraphics{ResponsesNoComp/MaskedResponseCurve3/15/G_masked.eps}
}\\
% }}
