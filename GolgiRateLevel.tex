...
\yellownote{Inclusion of Ghoshal figure needs agreement}
\begin{figure}[htb]
  \centering
...
\begin{figure}[hp!]
  \centering
%  \resizebox{3.5in}{!}{\includegraphics{NoFigure}}\\
  %\resizebox{0.8\textwidth}{!}{\includegraphics{gfx/GolgiDiagram}}\\
...
%  \resizebox{3.5in}{!}{\includegraphics{NoFigure}} \\
%  \resizebox{0.6\textwidth}{!}{\includegraphics[angle=-90]{GolgiRateLevel-2}} \\
