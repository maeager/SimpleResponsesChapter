...
%     $\alpha$ is the synaptic and dendritic smoothing function.
 ...
 Appendix~\ref{sec:chp3:appendix}.  %\medskip{}
...
\citep{FerragamoGoldingEtAl:1998}.  \todo[inline]{ The input spread parameter is
  ...
  widths in Golgi cells are \~100 micron and the frequency separation in the
  \VCN core is \~70 microns, giving an expected result of 1.5 connectivity
  spread hence the result of 2.48 channels gives added frequency spread from LSR
  fibres.}
