...
\yellownote{Para 1: Nordlie table~\ref{tab:TScellModelSummary}A. Using R\&M type 1-t, Other previous models}
...
individual connections from different cell types.    

   
    % The membrane parameters for the single compartment T~stellate cell model
    % above were: diameter =19.5$\mu$m, $\bar{g}_{\rm Na}=0$, $\bar{g}_{\rm
    % KHT}=0.0189416$ S cm$^{-2}$, $\bar{g}_{\rm leak}=0.000473539$ S cm$^{-2}$,
    % $\bar{g}_{\rm h}=6.20392e-05$ S cm$^{-2}$, $\bar{g}_{\rm KA}=0.01539$ S
...
\begin{figure}[htb!]
  \centering
\subfloat[Chopper Sustained]{\resizebox{0.35\textwidth}{!}{\includegraphics{TStellate/CS-01-864-004}}}\quad%
\subfloat[Chopper Transient 1]{\resizebox{0.35\textwidth}{!}{\includegraphics{TStellate/CT1-01-857-007}}}\\
\subfloat[Chopper Transient 2]{\resizebox{0.35\textwidth}{!}{\includegraphics{TStellate/CT2-01-305-014}}}\quad%
...
What is not shown in Figure~\ref{fig:TSinputs} is firstly the non-linear dynamics of the action potential in the neural model; and secondly the hyperpolarisation activation of Ih and I$_{\rm KA}$ currents due to inhibitory input.
