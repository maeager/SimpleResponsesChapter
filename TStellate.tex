...
\begin{figure}[htb]
  \centering
\subfloat[Chopper Sustained]{\resizebox{0.3\textwidth}{!}{\includegraphics{/media/data/Work/cnstellate/TStellate/CS-01-864-004}}}\hfill%\quad%
\subfloat[Chopper Transient 1]{\resizebox{0.3\textwidth}{!}{\includegraphics{/media/data/Work/cnstellate/TStellate/CT1-01-857-007}}}\hfill%\\
\subfloat[Chopper Transient 2]{\resizebox{0.3\textwidth}{!}{\includegraphics{/media/data/Work/cnstellate/TStellate/CT2-01-305-014}}}%\quad%
...
\begin{figure}[htb]
\centering%
\resizebox{0.95\textwidth}{!}{\includegraphics{/media/data/Work/cnstellate/TStellate_CS/multiplotIVCV.eps}}
...
D. Measures of membrane voltage including a) onset ratio ($v_{\rm 5-10}/v_{\rm 20-30}$), b) adaptation of sustained depolarisation ($v_{\rm 20-21} - v_{\rm 50-51}$ mV), and c) post-tone hyperpolarization ($v_{\rm RMP} - v_{\rm 60-61}$ mV).
