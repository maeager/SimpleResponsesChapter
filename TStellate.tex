...
\begin{figure}[htb]
\centering%
\subfloat[Chopper Sustained]{\resizebox{0.3\textwidth}{!}{\includegraphics{TStellate/CS-01-864-004-a}}}\hfill%\quad%
...
\begin{figure}[htb]
\centering%
\resizebox{0.9\textwidth}{!}{\includegraphics{TStellate/baseline_exc}}
\resizebox{0.9\textwidth}{!}{\includegraphics{TStellate/baseline_inh}}
...
The parameters for synapse's were: excitatory (tau = 0.36 msec), glycinergic (tau1=0.4 and tau2=2.5 msec), and GABAergic (tau1=0.26 and tau2=5.43 msec).\label{fig:TSinputs}}
\end{figure}

\begin{figure}[htb]
\centering%
%  \resizebox{0.6\textwidth}{!}{\includegraphics{TStellate/baseline_exc}}
\resizebox{0.9\textwidth}{!}{\includegraphics{TStellate/baseline_jitter.eps}}
