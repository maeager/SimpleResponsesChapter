...
#+BEGIN_LaTeX
\begin{eqnarray}
 \textrm{Onset Ratio} &= \bar{v}|_{t=0}^{t=5}\quad/\quad \bar{v}|_{t=20}^{t=25} \\
 \textrm{Adaptation} &= \bar{v}|_{t=20}^{t=21}\quad - \quad\bar{v}|_{t=50}^{t=51} \\
 \textrm{Offset} &= \bar{v}|_{t=-10}^{t=0}\quad - \quad\bar{v}|_{t=60}^{t=61} 
\end{eqnarray}
