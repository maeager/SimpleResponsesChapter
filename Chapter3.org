...
#+LABEL: fig:ZilanyBruceFig
  [[./gfx/ZilanyCarney-JASA-2009-Fig2]]
...
#+CAPTION:    [Rate level response of marginal shell units]{Rate level response of 6 units \citep[Reproduced with permission Fig.~2]{GhoshalKim:1996,GhoshalKim:1996a}. Unit S03-07 (CF 22.7\space kHz) at the top will be the unit chosen to optimise the Golgi cell model as it is monotonic, and has the median maximum rate of all the units shown. \yellownote{Inclusion of Ghoshal figure needs permission, fill in caption}}
#+LABEL:      fig:GolgiKimFig2
  [[GhoshalKim96_Fig2.png]]
...
#  %\resizebox{\textwidth}{!}{\includegraphics{GolgiRateLevel_result2}} \\
...
#     \includegraphics{RateLevel/response_area.3}%
#     \includegraphics{RateLevel/response_area_log2.3}}
#   \end{figure}
#   \begin{figure}[h]
#     \centering\resizebox{0.95\textwidth}{!}{%
#     %     \includegraphics{RateLevel/response_area.3}
#     \includegraphics{RateLevel/psthall90.3}%
#     \includegraphics{RateLevel/psthVlevel.3}}
#   \end{figure}
...
#   \begin{figure}[h]
#     \centering\resizebox{0.95\textwidth}{!}{%
#     \includegraphics{NoiseRateLevel/psthsingle120.3}%
#     \includegraphics{NoiseRateLevel/G_ratelevel}}
#   \end{figure}
#   \begin{figure}[h]
#     \centering\resizebox{0.95\textwidth}{!}{%
#     \includegraphics{NoiseRateLevel/response_area.3}%
#     \includegraphics{NoiseRateLevel/response_area_log2.3}}
#   \end{figure}
#   \begin{figure}[h]
#     \centering\resizebox{0.95\textwidth}{!}{%
#     %     \includegraphics{RateLevel/response_area.3}
#     \includegraphics{NoiseRateLevel/psthall90.3}%
#     \includegraphics{NoiseRateLevel/psthVlevel.3}}
#   \end{figure}
...
#   *** Masking Responses}
#   \begin{figure}[h!]
# \centering\resizebox{0.95\textwidth}{!}{\includegraphics{MaskedRateLevel/psthsingle90.3}\includegraphics{MaskedRateLevel/G_ratelevel}}
#   \end{figure}
#   \begin{figure}[h!]
#     \centering\resizebox{0.95\textwidth}{!}{%
#     \includegraphics{MaskedRateLevel/response_area.3}%
#     \includegraphics{MaskedRateLevel/response_area_log2.3}}
#   \end{figure}

#   \begin{figure}[h!]
#     \centering\resizebox{0.95\textwidth}{!}{%
#     %     \includegraphics{RateLevel/response_area.3}
#     \includegraphics{MaskedRateLevel/psthall90.3}%
#     \includegraphics{MaskedRateLevel/psthVlevel.3}}
#   \end{figure}
#   \clearpage

#   \begin{figure}[h!]
#     \centering\resizebox{0.95\textwidth}{!}{%
#     \includegraphics{MaskedResponseCurve/psthsingle5810.3}%
#     \includegraphics{MaskedResponseCurve/G_masked}}
#   \end{figure}
#   \begin{figure}[h!]
#     \centering\resizebox{0.95\textwidth}{!}{%
#     \includegraphics{MaskedResponseCurve/response_area.3}%
# \includegraphics{MaskedResponseCurve/response_area_log2log2.3}}
#   \end{figure}

#   \begin{figure}[h!]
#     \centering\resizebox{0.95\textwidth}{!}{%
#     %     \includegraphics{RateLevel/response_area.3}
#     \includegraphics{MaskedResponseCurve/psthall5810.3}%
#     \includegraphics{MaskedResponseCurve/psthVmod.3}}
#   \end{figure}
#   \clearpage
...
#+CAPTION: []{Experimental data showing click recovery in onset choppers \yellownote{Permission needed}}
#+LABEL: fig:BackoffPalombi
  [[./gfx/Backoff+Palombi-Fig]]
...
#   \includegraphics{RateLevel/psthsingle90.2}%
#   \includegraphics{RateLevel/DS_ratelevel}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{\textwidth}{!}{%
#   \includegraphics{RateLevel/response_area.2}%
#   \includegraphics{RateLevel/response_area_log2.2}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{\textwidth}{!}{%
# %   \includegraphics{RateLevel/response_area.2}
#   \includegraphics{RateLevel/psthall90.2}%
#   \includegraphics{RateLevel/psthVlevel.2}}
# \end{figure}
...
# \begin{figure}[h!]
#   \centering\resizebox{\textwidth}{!}{%
#   \includegraphics{NoiseRateLevel/psthsingle120.2}%
#   \includegraphics{NoiseRateLevel/DS_ratelevel}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{\textwidth}{!}{%
#   \includegraphics{NoiseRateLevel/response_area.2}%
#   \includegraphics{NoiseRateLevel/response_area_log2.2}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{\textwidth}{!}{%
# %   \includegraphics{RateLevel/response_area.2}
#   \includegraphics{NoiseRateLevel/psthall90.2}%
#   \includegraphics{NoiseRateLevel/psthVlevel.2}}
# \end{figure}
...
# \begin{figure}[h!]
# \centering\resizebox{\textwidth}{!}{\includegraphics{MaskedRateLevel/psthsingle90.2}\includegraphics{MaskedRateLevel/DS_ratelevel}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{\textwidth}{!}{%
#   \includegraphics{MaskedRateLevel/response_area.2}%
#   \includegraphics{MaskedRateLevel/response_area_log2.2}}
# \end{figure}

# \begin{figure}[h!]
#   \centering\resizebox{\textwidth}{!}{%
# %   \includegraphics{RateLevel/response_area.2}
#   \includegraphics{MaskedRateLevel/psthall90.2}%
#   \includegraphics{MaskedRateLevel/psthVlevel.2}}
# \end{figure}
# \clearpage
# ** Masked Response Area}
# \begin{figure}[h!]
#   \centering\resizebox{\textwidth}{!}{%
#   \includegraphics{MaskedResponseCurve/psthsingle5810.2}%
#   \includegraphics{MaskedResponseCurve/DS_masked}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{\textwidth}{!}{%
#   \includegraphics{MaskedResponseCurve/response_area.2}%
# \includegraphics{MaskedResponseCurve/response_area_log2log2.2}}
# \end{figure}

# \begin{figure}[h!]
#   \centering\resizebox{\textwidth}{!}{%
# %   \includegraphics{RateLevel/response_area.2}
#   \includegraphics{MaskedResponseCurve/psthall5810.2}%
#   \includegraphics{MaskedResponseCurve/psthVmod.2}}
# \end{figure}
# \clearpage
...
* [TV Cell Model]{Tuberculoventral Cell Model: Fitting Tone and Noise Rate Level Curves}
...
#+CAPTION: [Experimental data of a single Type-II\space DCN\space unit]{Experimental data of a single Type-II\space DCN\space unit \citep[Fig.\space 1]{SpirouDavisEtAl:1999}. \yellownote{Figure\space \ref{fig:SpirouFig1} needs permission}}
...
#+CAPTION: [Experimental notch-noise data of a single Type-II DCN unit]{Experimental notch-noise data of a single Type-II DCN unit \citep[,\space Fig.\space 9]{ReissYoung:2005}. \yellownote{Permission needed for Reiss and Young figures}}
...
#+LABEL: fig:TV_result_Run2_50
 [[TV_Notch/Run2/spl50/TV_Notch_result]]
...
# \begin{figure}[h!]
#   \centering\resizebox{0.95\textwidth}{!}{%
#   \includegraphics{RateLevel/psthsingle90.1}%
#   \includegraphics{RateLevel/TV_ratelevel}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{0.95\textwidth}{!}{%
#   \includegraphics{RateLevel/response_area.1}%
#   \includegraphics{RateLevel/response_area_log2.1}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{0.95\textwidth}{!}{%
# %   \includegraphics{RateLevel/response_area.1}
#   \includegraphics{RateLevel/psthall90.1}%
#   \includegraphics{RateLevel/psthVlevel.1}}
# \end{figure}
...
# \begin{figure}[h!]
#   \centering\resizebox{0.95\textwidth}{!}{%
#   \includegraphics{NoiseRateLevel/psthsingle120.1}%
#   \includegraphics{NoiseRateLevel/TV_ratelevel}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{0.95\textwidth}{!}{%
#   \includegraphics{NoiseRateLevel/response_area.1}%
#   \includegraphics{NoiseRateLevel/response_area_log2.1}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{0.95\textwidth}{!}{%
# %   \includegraphics{RateLevel/response_area.1}
#   \includegraphics{NoiseRateLevel/psthall90.1}%
#   \includegraphics{NoiseRateLevel/psthVlevel.1}}
# \end{figure}
...
# \begin{figure}[h!]
# \centering\resizebox{0.95\textwidth}{!}{\includegraphics{MaskedRateLevel/psthsingle90.1}\includegraphics{MaskedRateLevel/TV_ratelevel}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{0.95\textwidth}{!}{%
#   \includegraphics{MaskedRateLevel/response_area.1}%
#   \includegraphics{MaskedRateLevel/response_area_log2.1}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{0.95\textwidth}{!}{%
# %   \includegraphics{RateLevel/response_area.1}
#   \includegraphics{MaskedRateLevel/psthall90.1}%
#   \includegraphics{MaskedRateLevel/psthVlevel.1}}
# \end{figure}
# \clearpage
# ** Masked Response Area}
# \begin{figure}[h!]
#   \centering\resizebox{0.95\textwidth}{!}{%
#   \includegraphics{MaskedResponseCurve/psthsingle5810.1}%
#   \includegraphics{MaskedResponseCurve/TV_masked}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{0.95\textwidth}{!}{%
#   \includegraphics{MaskedResponseCurve/response_area.1}%
# \includegraphics{MaskedResponseCurve/response_area_log2log2.1}}
# \end{figure}
# \begin{figure}[h!]
#   \centering\resizebox{0.95\textwidth}{!}{%
# %   \includegraphics{RateLevel/response_area.1}
#   \includegraphics{MaskedResponseCurve/psthall5810.1}%
#   \includegraphics{MaskedResponseCurve/psthVmod.1}}
# \end{figure}
# \clearpage
...
#+CAPTION: [Regularity in chopper units]{Regularity in chopper units \citep[Data reproduced from Fig.\space 2,\space ][]{PaoliniClareyEtAl:2005}}
...
#       \begin{figure}[htb]
#         \centering\resizebox{0.95\textwidth}{!}{%
#  %         \includegraphics{RateLevel/response_area.0}%
#   %        \includegraphics{RateLevel/response_area_log2.0}}
#       \end{figure}
#       \begin{figure}[htb]
#         \centering\resizebox{0.95\textwidth}{!}{%
#           % \includegraphics{RateLevel/response_area.0}
#           \includegraphics{RateLevel/psthall90.0}%
#           \includegraphics{RateLevel/psthVlevel.0}}
#       \end{figure}
...
#       \begin{figure}[htb]
#         \centering\resizebox{0.95\textwidth}{!}{%
#           \includegraphics{NoiseRateLevel/psthsingle120.0}%
#           \includegraphics{NoiseRateLevel/TS_ratelevel}}
#       \end{figure}
#       \begin{figure}[htb]
#         \centering\resizebox{0.95\textwidth}{!}{%
#           \includegraphics{NoiseRateLevel/response_area.0}%
#           \includegraphics{NoiseRateLevel/response_area_log2.0}}
#       \end{figure}
#       \begin{figure}[htb]
#         \centering\resizebox{0.95\textwidth}{!}{%
#           % \includegraphics{RateLevel/response_area.0}
#           \includegraphics{NoiseRateLevel/psthall90.0}%
#           \includegraphics{NoiseRateLevel/psthVlevel.0}}
#       \end{figure}
...
#       ** Masked Noise and Tone}
#       \begin{figure}[h!]
# \centering\resizebox{0.95\textwidth}{!}{\includegraphics{MaskedRateLevel/psthsingle90.0}\includegraphics{MaskedRateLevel/TS_ratelevel}}
#       \end{figure}
#       \begin{figure}[h!]
#         \centering\resizebox{0.95\textwidth}{!}{%
#           \includegraphics{MaskedRateLevel/response_area.0}%
#           \includegraphics{MaskedRateLevel/response_area_log2.0}}
#       \end{figure}

#       \begin{figure}[h!]
#         \centering\resizebox{0.95\textwidth}{!}{%
#           % \includegraphics{RateLevel/response_area.0}
#           \includegraphics{MaskedRateLevel/psthall90.0}%
#           \includegraphics{MaskedRateLevel/psthVlevel.0}}
#       \end{figure}
#       \clearpage
#       ** Masked Response Area}
#       \begin{figure}[h!]
#         \centering\resizebox{0.95\textwidth}{!}{%
#           \includegraphics{MaskedResponseCurve/psthsingle5810.0}%
#           \includegraphics{MaskedResponseCurve/TS_masked}}
#       \end{figure}
#       \begin{figure}[h!]
#         \centering\resizebox{0.95\textwidth}{!}{%
#           \includegraphics{MaskedResponseCurve/response_area.0}%
#           \includegraphics{MaskedResponseCurve/response_area_log2log2.0}}
#       \end{figure}

#       \begin{figure}[h!]
#         \centering\resizebox{0.95\textwidth}{!}{%
#           % \includegraphics{RateLevel/response_area.0}
#           \includegraphics{MaskedResponseCurve/psthall5810.0}%
#           \includegraphics{MaskedResponseCurve/psthVmod.0}}
#       \end{figure}
#       \clearpage
