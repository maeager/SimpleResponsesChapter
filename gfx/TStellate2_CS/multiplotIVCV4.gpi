...
plot '../SimpleResponsesChapter/gfx/TStellate2_CS/TStellate.Fit.dat' u ($1):2 t "Test" w l lc "black", \
     '< tail -91 ../SimpleResponsesChapter/gfx/TStellate/CS-01-864-004.png.dat' u 1:2 t "Reference" w l lc rgb "#0060ad"
unset key
...
set xtics nomirror out rotate by -20 offset -1,0 ("Onset" 0,"Adaptation" 1,"Offset" 3)
...
plot '< awk ''/IVOnset/ {if ($3!=0) print $3,$4; end}'' ../SimpleResponsesChapter/gfx/TStellate2_CS/TStellate.Fit.dat'  u 1 axes x1y1 t "Test" w lp lc "black" lt 1 lw 2 pt 7 ps 1.5, \
     '' u 2 axes x1y1 t "Ref" w lp ls 1 pt 5 ps 1.5, \
     '< awk ''/IVAdapt/ {if ($3!=0) print $3,$4; end}'' ../SimpleResponsesChapter/gfx/TStellate2_CS/TStellate.Fit.dat' u ($0+1):1 axes x2y2 not  w lp lc "black" lt 1 lw 2 pt 7 ps 1.5, \
     '' u ($0+1):2 axes x2y2 not w lp ls 1 pt 5 ps 1.5, \
     '< awk ''/IVOffset/ {print $3,$4}'' ../SimpleResponsesChapter/gfx/TStellate2_CS/TStellate.Fit.dat' u ($0+2):1 axes x2y2 not w lp lc "black" lt 1 lw 2 pt 7 ps 1.5, \
     '' u ($0+2):2 axes x2y2 not w lp ls 1 pt 5 ps 1.5 
