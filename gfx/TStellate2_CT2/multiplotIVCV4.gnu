...
set terminal postscript eps enhanced defaultplex \
   ...
   "Helvetica" 18
#color solid
set output "../SimpleResponsesChapter/gfx/TStellate2_CT2/multiplotIVCV4.eps"
...
plot [-10:90] '../SimpleResponsesChapter/gfx/TStellate2_CT2/psth_0.25.dat' i 0 u 1:2 notitle w boxes lc "black"
...
plot [-0.5:3.5][0.1:0.6] '< grep -A4 -e ''CV reference'' ../SimpleResponsesChapter/gfx/TStellate2_CT2/TStellate.Fit.dat | tr ''#'' '' '' | tr ''-'' ''\n''| grep -v -e ''CV'' ' \
...
plot '../SimpleResponsesChapter/gfx/TStellate2_CT2/TStellate.Fit.dat' u ($1):2 t "Test" w l lc "black", \
     '< tail -137 ../SimpleResponsesChapter/gfx/TStellate/CT2-01-305-014.png.dat' u 1:2 t "Reference" w l lc rgb "#0060ad"
unset key
...
plot '< awk ''/IVOnset/ {if ($3!=0) print $3,$4; end}'' ../SimpleResponsesChapter/gfx/TStellate2_CT2/TStellate.Fit.dat'  u 1 axes x1y1 t "Test" w lp lc "black" lt 1 lw 2 pt 7 ps 1.5, \
     '' u 2 axes x1y1 t "Ref" w lp ls 1 pt 5 ps 1.5, \
     '< awk ''/IVAdapt/ {if ($3!=0) print $3,$4; end}'' ../SimpleResponsesChapter/gfx/TStellate2_CT2/TStellate.Fit.dat' u ($0+1):(abs($2)) axes x2y2 not  w lp lc "black" lt 1 lw 2 pt 7 ps 1.5, \
     '' u ($0+1):(abs($1)) axes x2y2 not w lp ls 1 pt 5 ps 1.5, \
     '< awk ''/IVOffset/ {print $3,$4}'' ../SimpleResponsesChapter/gfx/TStellate2_CT2/TStellate.Fit.dat' u ($0+4):(abs($2)) axes x2y2 not w lp lc "black" lt 1 lw 2 pt 7 ps 1.5, \
...
unset multiplot
!fixbb ../SimpleResponsesChapter/gfx/TStellate2_CT2/multiplotIVCV4.eps
