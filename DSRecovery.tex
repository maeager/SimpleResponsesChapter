...
\graphicspath{{../figures/}{./gfx/}{/media/data/Work/cnstellate/DS_ClickRecovery/}{/media/data/Work/Responses/}}
...
contralateral CN \citep{NeedhamPaolini:2007}.
...
[Discuss AM coding by DS cells] \citep{CasparyPalombiEtAl:2002} GABA
blockers in the VCN has the effects of changing the behaviour in the
response to AM in the IC.  \citep{BackoffShadduckEtAl:1999} AM coding
effects of GABA in the Chinchilla CN.  \citep{CasparyBackoffEtAl:1994}
...
%\resizebox{5in}{!}{\includegraphics[angle=-90]{DSClickRecoveryExpData}}
...
%\resizebox{3.5in}{!}{\includegraphics[keepaspectratio=true,angle=-90,width=0.9\textwidth]{./gfx/DS_ClickRecovery_result.eps}}
