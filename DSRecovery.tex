...
The first spike latency in \DS~cells $2.8 \pm 0.09$ ms \citep{RhodeSmith:1986}.
...
\begin{figure}[htb]
  \centering
  \resizebox{0.6\textwidth}{!}{\includegraphics{DS_ClickRecovery/ANinput}}
...
%}\quad%   \subfloat[Golgi cell]{
  ...
  \caption[Click recovery stimulus]{Click stimulus and PSTH responses of an HSR fibre, a GLG unit, and a D~stellate cell from the click recovery stimulus used in the optimisation. }\label{fig:ClickExamples}
\end{figure}
...
\begin{figure}[htb]
  ...
  \resizebox{0.8\textwidth}{!}{\includegraphics[height=\textwidth,keepaspectratio,angle=-90]{DS_ClickRecovery/DS_ClickRecovery_result}}
...
\begin{figure}[htb]
  \centering
  \figfont{A}\hfill\figfont{B}\hfill\\
  \resizebox{0.95\textwidth}{!}{\includegraphics{ResponsesNoComp/DS_ratelevel_combined.eps}\includegraphics{ResponsesNoComp/RateLevel/psthsingle90.2.eps}}\\
  \figfont{C}\hfill\figfont{D}\hfill\\
  \resizebox{0.95\textwidth}{!}{\includegraphics{ResponsesNoComp/RateLevel/response_area.2.eps}%
\includegraphics{ResponsesNoComp/MaskedResponseCurve3/15/DS_masked.eps}
}\\
% }}
