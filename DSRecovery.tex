...
standard deviations \citep{PaoliniClark:1999}.
 ...
 \begin{figure}[htb]
   \centering
   \subfig[D~stellate cell]{\includegraphics[width=0.5\textwidth]{DS_ClickRecovery_DSpsth} \label{fig:DSClickRecoveryPSTH}}
   \subfig[Golgi cell]{\includegraphics[width=0.5\textwidth]{DS_ClickRecovery_Gpsth}\label{fig:GClickRecoveryPSTH}}
