\section[]{Tuberculoventral Cell Model: Fitting Tone and Noise Rate Level Curves}
...
\centering
% \resizebox{5in}{!}{\includegraphics[angle=-90]{NoFigure}}
\includegraphics[keepaspectratio,width=0.8\textwidth]{TV_RateLevel/TV_RateLevel_Fig8.eps}
\caption[Experimental data of a single Type-II~DCN~unit]{Experimental data of a single Type-II~DCN~unit \citep[Fig.~1]{SpirouDavisEtAl:1999}.}
\label{fig:SpirouFig1}
\end{figure}
...
\begin{figure}[htb]
\centering
\includegraphics[keepaspectratio,width=0.8\textwidth]{TV_RateLevel/TV_RateLevel_result}
...
\section[TV Cell Model]{Tuberculoventral Cell Model: Optimisation of Asymmetric Inhibition using Notch-Noise} \label{sec:TV-cell-model}
% - A
% ------------------------------------------------------------------------------
