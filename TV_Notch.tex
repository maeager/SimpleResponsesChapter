...
%\smallskip{}
 ...
 \begin{figure}[htb]
   \centering \resizebox{0.8\textwidth}{!}{\includegraphics[angle=-90]{NoFigure}} \includegraphics[keepaspectratio,width=0.8\textwidth]{./gfx/TV_Reiss}
...
\includegraphics[width=0.48\textwidth,keepaspectratio]{ResponsesNoComp/TV_ratelevel_combined.eps}\includegraphics[width=0.48\textwidth,keepaspectratio]{ResponsesNoComp/RateLevel/psthsingle90.1.eps}\\
%}\\
...
\includegraphics[width=0.48\textwidth,keepaspectratio]{ResponsesNoComp/MaskedResponseCurve3/15/TV_masked.eps}\\
%}\\
% }}
