...
presentation across an entire network. Accordingly, the fitness function must take into
account the relative position of the notch when comparing the experimental data.
For example, when presented with a notch noise filtered between (5kHz-10kHz), a
...
\ref{fig:TVNotchDiagram} shows the combination of the type II unit notch data
for 1 octave.

The sound level in the \citet{ReissYoung:2005} data further complicates the situation.  The spectrum is processed and scaled at each point in the notch sweep.
...
First Error of 0.0167  (MSE Normalised rate between 4.57-18.68 kHz channels), was run in Dec 2009. \yellownote{More work is being done now on a more recent result}
