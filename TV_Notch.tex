...
\begin{figure}[htb]
  ...
  \resizebox{0.95\textwidth}{!}{\includegraphics{ResponsesNoComp/TV_ratelevel_combined.eps}\includegraphics{ResponsesNoComp/RateLevel/psthsingle90.1.eps}}\\
  \figfont{C}\hfill\figfont{D}\hfill\\
  \resizebox{0.95\textwidth}{!}{\includegraphics{ResponsesNoComp/RateLevel/response_area.1.eps}%
\includegraphics{ResponsesNoComp/MaskedResponseCurve3/15/TV_masked.eps}
}\\
% }}
