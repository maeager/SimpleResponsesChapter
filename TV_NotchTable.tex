...
\multirow{3}{*}{\textbf{Neuron model}} & Golgi: instantaneous-rate Poisson spike trains\\
                                       & D~stellate: HH-like single-compartment model (Type I-II R\&M model)\\ 
...
\textbf{Subthreshold dynamics} & \INa, \IKHT, \Ih, \Ileak
...
\textbf{Input Stimulus}  & Stop-band filtered white noise (60 dB SPL, 50 ms duration, 2 ms cosine squared on\slash off ramp, 20 ms delay)   \\\hline
...
\textbf{Measurements} & spiking output of all 100 TV units across the network, with 25 repetitions.\\
% %\multicolumn{2}{|c|}{\begin{minipage}[c]{0.8\textwidth}%
