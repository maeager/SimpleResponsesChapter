...
interface, and \citet{MiglioreCanniaEtAl:2006} for the parallel NEURON network model \textsf{netmod} (SenseLab model ).

\url{52034}{http://senselab.med.yale.edu/senselab/modeldb/ShowModel.asp?model=52034}
\url{2730}{http://senselab.med.yale.edu/senselab/modeldb/ShowModel.asp?model=2730}
\url{51781}{http://senselab.med.yale.edu/senselab/modeldb/ShowModel.asp?model=51781}
...
interface to the compiled library. 

The first run of a stimulus may take some time if the AN
...
\begin{figure}[htb]
  \begin{center}
    ...
    \caption[Zilany auditory model conversion in NEURON]{Getting audiogram compression values for Zilany model in
...
\begin{figure}[htb]
  \begin{center}
    ...
    \caption[Hearing threshold of the domestic cat]{Hearing threshold of the domestic cat by
