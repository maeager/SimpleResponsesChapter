...
\todo[inline]{Special comments on the use of g3data to extract datapoints from PDF literature documents }
...
\subsubsection[Golgi model]{Golgi cell model optimisation}\label{sec:APDX:golgi-cell-model}
