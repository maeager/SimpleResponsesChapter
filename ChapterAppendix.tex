...
\includegraphics{gfx/Audiogram_COHC_CIHC_cat}
...
\begin{figure}[htb]
  \begin{center}
    ...
    \caption[Hearing threshold of the domestic cat]{Hearing threshold of the domestic cat by \citet{HeffnerHeffner:1985} 
(Data file \mbox{\textsf{``heffner\_1985a\_felis\_p347\_3.txt''}} obtained from [earlab.bu.edu])}
