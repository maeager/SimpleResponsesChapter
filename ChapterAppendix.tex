...
\begin{figure}[htb]
  \begin{center}
    \resizebox{\textwidth}{!}{\includegraphics[keepaspectratio=true]{NoFigure}}%Audiograms.jpg}}
...
\begin{lstlisting}[label=GolgiTemplate,caption=Rate-based golgi cell model
  template (in par_CNcell.tem)]
