...
\end{quotation}\yellownote{Get page number of this quote}
...
that use highly-specific sensory pathways. \todo{One more sentence here - expand on idea at the start and link to next para.} 

\medskip{}

Although it remains the case that ``choices, assumptions, and guesses [are] an
integral part of neuronal modeling'' \citep[\todo{page
...
NEURON).\todo{which? need to explain my intentions}
...
and their constituents. \todo{this needs more explanation in the methods sections}
...
routine could be performed all at once or reiterated in sequential stages\todo{unclear sentence}. The
...
PSTH (although this may vary within cell type).\todo{what is this sentence
  doing? explain the figure!}  The stellate network model drawn in
...
\begin{figure}[htb]
  ...
  \caption{Cochlear nucleus stellate microcircuit (see text for details).\todo{still put some text in here to describe it} }
...
\todo{This probably goes in Chapter 2}To understand the auditory system, one
...
spectral, onset and other feature-based information pathways.\todo{reference}
