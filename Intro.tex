...
also becoming more advanced, for example SSNNS~\citep{SichtigSchafferEtAl:2008}, NeuroFitter \citep{VanAchardEtAl:2007}~and
...
\yellownote{what is the follwoing sentence doing? explain the figure!}  
...
cortex in terms of frequency selectivity, also called tonotopicity~\citep{YoungOertel:2004}.  The population of auditory nerve fibres (ANFs,
...
model \citep{ZilanyBruceEtAl:2009}. The AN model consists of an outer\slash middle ear
