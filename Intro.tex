...
that use highly-specific sensory pathways. \todo[inline]{One more sentence here - expand on idea at the start and link to next para.} 
...
routine could be performed all at once or reiterated in sequential stages\todo[inline]{unclear sentence}. The
...
PSTH (although this may vary within cell type). \todo[inline]{what is this sentence
...
\todo[inline]{This probably goes in Chapter 2}To understand the auditory system, one
...
spectral, onset and other feature-based information pathways.\todo[inline]{reference}
...
\todo[inline]{TODO: AN model paragraph has been changed - fix any comment related
...
% \todo[inline]{TODO: serious reworking to be done here} Analysis of the frequency
...
[Discuss R\&M model]
\todo[inline]{TODO: Is this a replication of other work or have I changed it enough that it needs to be shown or too general to go in this chapter (put in Methods Chapter}
