...
especially those that use highly-specific sensory pathways.  \yellownote{One
...
integral part of neuronal modeling'' \citep{SegevBurkeEtAl:1998} \yellownote{page
...
NEURON).\yellownote{which? need to explain my intentions}
...
and their constituents. \yellownote{this needs more explanation in the methods sections}
...
Each cell type is shown with its \gls{EIRA} and
\gls{PSTH}, although this may vary within cell types. 


\yellownote{what is this sentence doing? explain the figure!}  The stellate network model drawn in
...
\item The Golgi cell: a {GABA}ergic \VCN~marginal shell unit that is presumed to
  ...
  I/III response area and characterised {PSTH} with unusual or chopper characteristics in
...
into \gls{HSR} and \gls{LSR} fibres
...
\yellownote{TODO: AN model paragraph has been changed - fix any comment
