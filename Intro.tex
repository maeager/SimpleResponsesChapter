...
The exceptional feature of hearing perception in animals (i.e.\
advanced signal processing and localisation) comes from a
...
tonotopicity.  The population of auditory nerve fibers (ANFs),
...
spontaneous rate (HSR) and low spontaneous rate (LSR) fibres. LSR
fibres have a higher threshold and wider dynamic range than HSR fibres
\citep{citation}. They also project to the granule cell domain
