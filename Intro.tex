...
\yellownote{One more sentence here - expand on idea at the start and
  link to next para.}
...
\yellownote{need to explain my intentions}
...
\yellownote{Expand previous sentence - separate EIRA and PSTH definitions. What is the follwoing sentence doing? explain the figure!}  
...
Tonotopic connectivity in the stellate cochlear nucleus model is defined by the regular organisation of afferent ANFs into distint isofrequency channels. 
