...
%    \resizebox{3.5in}{!}{\includegraphics[keepaspectratio=true]{NoFigure}}
    ...
    \caption{Auditory periphery model with dual power-law synapse \citep[originally printed in ][\textbf{needs permission}]{ZilanyBruceEtAl:2009}.}
    \label{fig:ZilanyBruceFig}
  \end{center}
\end{figure}\yellownote{if this figure is used it needs to be verified by the original authors}
...
[Discuss R\&M model]
\yellownote{TODO: replication of other work or slight change that needs to be shown or too general to go in this chapter (put in Methods Chapter}
...
\begin{figure}[tbh]
  \begin{center}
%    \resizebox{3.5in}{!}{\includegraphics[keepaspectratio=true]{NoFigure}}
    \resizebox{0.8\textwidth}{!}{\includegraphics[keepaspectratio=true]{gfx/CNConn}}
