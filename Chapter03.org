...
This section describes the some of the general methods used within this chapter. Chapter \ref{sec:Ch2:Methods} describes the common methods in more detail.
