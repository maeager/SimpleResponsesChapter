...
The next section introduces the major wide-band onset inhibitor of the \CNSM model, the \DS cell. 
...
neurotransmitter GABA, predominantly at \GABAa receptor synapses  \citep{FerragamoGoldingEtAl:1998a}.  Golgi cells
are the only \GABA-ergic neuron in the VCN, but their axonal plexus does
...
#The best parameters \yellownote{TODO complete sentence}
...
Spike times for a single repetition were ignored for \CV calculations without the first three regular spikes or spikes occurring before the stimulus onset.
\CV of the inter-spike intervals was calculated
