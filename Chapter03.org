...
to one in cats \citep{RyugoParks:2003}. The size of their soma is generally smaller than \DS cells, ranging from 16--20 \um \citep{PalmerWallaceEtAl:2003,ReddCahillEtAl:2002,DoucetRyugo:1997,DoucetRyugoEtAl:1999,DoucetRyugo:2006}, with one study suggesting variation in soma size across the nucleus (14.5 \pm 2.0 high CF,  17.6 \pm 2.7 low CF, in chinchilla \citealt*{JosephsonMorest:1998}).  Two to four primary dendrites
emanate from their cell body, extending 150-300 \um parallel to \ANF
axons and do not extend beyond the isofrequency lamina of similar CF
units \citep{SmithRhode:1989,PalmerWallaceEtAl:2003}.  \TS cells are
...
In response to intracellular current injection \TS cells have a Type I current clamp response. They fire with regularly spaced, single-exponential undershoot APs and have a linear current-voltage response \citep{OertelWuEtAl:1988,OertelWuEtAl:1990,RhodeOertelEtAl:1983,SmithRhode:1989,FengKuwadaEtAl:1994,WuOertel:1984}.  
The effective membrane time constant varies between species ranging from 6 to 18 ms 
\citep{ManisMarx:1991,IsaacsonWalmsley:1995}.
\TS cells have no \IKLT, but do have two currents active at rest, \IKA and \Ih \citep{ManisMarx1991,RothmanManis:2003}.
...
Few synaptic terminals contact the cell body of \TS cells, the majority of inputs contacting the proximal dendrites \citep{Cant:1981}. 



The chopping pattern shown in Figure \ref{fig:microcircuit} is characteristic of \TS cells. Sustained and transient choppers (ChS and ChT) are differentiated by the regularity of discharge throughout the stimulus \citep{YoungRobertEtAl:1988}.   
