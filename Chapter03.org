...
Shihab Shamma calls upon the neuroscience community 
to investigate the role of populations of neurons in neurophysiology. 
...
although this may vary within cell types.  \yellownote{TODO: Explain the
...
The restricted network models to be optimised in each section are presented in their
Background sub-section.   Criteria to be satisfied are presented in Implementation
