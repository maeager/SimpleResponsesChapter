...
The contribution of the circuits of granule cell areas of the \VCN to the processing of the acoustic signal is poorly understood
...
cell. The weighted Gaussian function.
...
biophysically-realistic neural network model of the stellate microcircuit in the
