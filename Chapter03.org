...
#+BEGIN_LaTeX
  \begin{figure}[t!]
    ...
    \resizebox{0.5\textwidth}{!}{\includegraphics{../../cnstellate/ResponsesNoComp/psthblock-2.pdf}}%
...
distal dendrites of DS cells.  Two important results came out of the click
...
the rise time of the \GABAa synapse.  and a decay constant under 6 ms is
necessary to
...
\yellownote{TODO: Discuss the DS cell model optimisation.}
