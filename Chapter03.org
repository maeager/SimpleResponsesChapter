...
call_grabTSdata[:in-file ./gfx/TStellate2_CS/TStellate.Fit.dat ](regexp="#  Input Resistance =",ind=5)[:results replace raw]
...
#+BEGIN_SRC octave :export none :results value vector 
  clear
  [sysstat out] = system ("  grep -A6 -e '^# weights' gfx/TStellate2_CS/TStellate.Fit.dat | tail -5 | tr -d '#'");
  wchs = str2num(out);
  [sysstat out] = system ("  grep -A6 -e '^# weights' gfx/TStellate2_CT1/TStellate.Fit.dat | tail -5 | tr -d '#'");
  wcht1 = str2num(out);
  [sysstat out] = system ("  grep -A6 -e '^# weights' gfx/TStellate2_CT2/TStellate.Fit.dat | tail -5 | tr -d '#'");
  wcht2 = str2num(out);
  [sysstat out] = system ("  grep -A6 -e '^# num. connections' gfx/TStellate2_CS/TStellate.Fit.dat | tail -5 | tr -d '#'");
  nchs = str2num(out);
  [sysstat out] = system ("  grep -A6 -e '^# num. connections' gfx/TStellate2_CT1/TStellate.Fit.dat | tail -5 | tr -d '#'");
  ncht1 = str2num(out);
  [sysstat out] = system ("  grep -A6 -e '^# num. connections' gfx/TStellate2_CT2/TStellate.Fit.dat | tail -5 | tr -d '#'");
  ncht2 = str2num(out);
...
#+BEGIN_SRC sh
  grep -A6 -e '^# weights' gfx/TStellate2_CT2/TStellate.Fit.dat | tail -5 | tr -d '#'
