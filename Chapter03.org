...
\yellownote{FIX tHis} of acoustic threshold and the gradient of firing rate with
...
#+BEGIN_LaTeX
  ...
  \caption[Sustained chopper optimisation results]{Optimisation results for the
    ...
    adaptation of sustained depolarisation \MP difference (20,30,40 dB re $\theta$,
    see Equation~\ref{eq:IVstats-Adap}), and (c) post-tone hyperpolarisation \MP difference(20,30,40
