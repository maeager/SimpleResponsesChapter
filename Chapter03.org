...
The onset ratio measure was calculated as the ratio in peak onset \MP depolarisation
...
The adaptation shift measurement calculates the drop in \MP depolarisation at the
...
#+BEGIN_LaTeX
  ...
  \end{equation}
#+END_LaTeX
Negative values indicate post-stimulus \MP hyperpolarisation which is caused by
reduced excitation or the presence of inhibition.  The post-stimulus \MP
