...
#+RESULTS: DSRL_RMS
: RE tone 57.49%  noise 52.09%   RMS tone 38.65 noise 30.42 total 44.14)RE tone 74.56%  noise
...
The \DS cell model of the \CNSM model has been optimised to have the
characteristics of a typical \OnC unit of the \VCN.  
