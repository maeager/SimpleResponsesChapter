...
\citet{ArleKim:1991a} were the first to show Type II \EIRA units with
 simple McCullock-Pitts point neuron models of the \DCN.
\citet{BlumReedEtAl:1995} created an abstract steady-state rate model to determine the effects of network connectivity in the \DCN. \citet{HancockDavisEtAl:1997} improved the spiking model by incorporating cross-correlation analysis and others in Davis collaborations    
\citep{YoungDavis:2002,HancockDavisEtAl:2001,DavisYoung:2000,SpirouDavisEtAl:1999,HancockDavisEtAl:1997,DavisVoigt:1996,DavisVoigt:1994,DavisVoigt:1991}. The most recent model from \citet{ReissYoung:2005},  suggests asymmetry in Type II \DCN units' response to notch noise is due to an offset in the distribution of wide-band inhibition from \DS cells. 
