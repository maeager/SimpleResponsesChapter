...
#+BEGIN_LaTeX
  ...
  \begin{tabularx}{0.8\linewidth}{lXXXXX}
  \toprule
                                  & \HSR \ANF &            \TS             &            \DS             &            \TV             & Golgi \\\otoprule
          R\&M Cell type          &           &          Type I-t          &         Type I-II          &          Type I-c          & Type I-c\\ 
  Experimental Mean FSL \quad (ms)&     -     & 3.6$\,^{ 1}$ & 2.8 $\,^{2}$ & 4.0 $\,^{3}$ & 4.3 $\,^{4}$\\ 
    Model Mean FSL  \quad (ms)    &    1.5    &            2.0             &            1.6             &            2.0             & 2.0\\ 
    Additional delay \quad (ms)   &     -     &            1.6             &            1.2             &            2.0             & 2.3\\\bottomrule
  \end{tabularx}\\
...
filtering mechanism in the Golgi cell.  
The synaptic and dendritic filter kernel, $\alpha(t)$ was
 normalised by setting the area under the function to 1.[fn:: For a large
enough filter length, the alpha function integral ($\int \alpha(t) dt = (-\Gtau^2 - t \cdot \Gtau)\cdot \exp(-\frac{t}{\Gtau})$) approximately equals $\Gtau^2$. In this case $10 \times \Gtau$ is used for the filter length.]
A more detailed explanation of the NEURON
...
#+BEGIN_LaTeX
  ...
  \begin{tabularx}{\textwidth}{X X X D{,}{.}{2.4}}
  \toprule 
...
#+BEGIN_LaTeX
  ...
  \begin{tabularx}{\textwidth}{X X X D{,}{.}{1.4}}
  \toprule
...
#+BEGIN_LaTeX
  ...
  \begin{table}[htb]
   ...
   \textbf{Parameters}   & \textbf{Range}& \multicolumn{1}{c}{\textbf{Final Value}} \\\otoprule
  ...
  Tone RL\ Error \hfill (sp/s)  &    25,62     & \\   
  Noise RL\ Error \hfill (sp/s) &    36,27     & \\ 
    Total Error \hfill (sp/s)   &    61,89     & \\ \bottomrule
  \end{tabularx}
  \end{table}
  \vspace{2ex} 
  }
...
#+BEGIN_LaTeX
    ...
    \begin{table}[htbp]
      ...
      \begin{tabularx}{0.8\textwidth}{X X D{,}{.}{3.4}} 
  \toprule
  \textbf{Parameters}& \textbf{Ranges}&\multicolumn{1}{c}{\textbf{Final Value}} \\\otoprule
