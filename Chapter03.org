...
in Section [[sec:Methods:SynapseModels]].  The synapses act by changing in the
...
#+BEGIN_LaTeX
  ...
  \hfill\resizebox{0.45\textwidth}{!}{\includegraphics{../figures/Fujino_Fig1E.png}}\\
%\includegraphics{../figures/Fujino_Fig1E.png}}
  %\includegraphics{../figures/Fujino_Fig1F.png}}\\
  ...
  B. Current clamp response of a DS cell in an /in vitro/ slice preparation to 0.1 nA and 0.6 nA current injections. This cell shows a prominent hyperpolarising sag and double exponential AP   \citep[reproduced~from~Figure~1~E][]{FujinoOertel:2001}. %
