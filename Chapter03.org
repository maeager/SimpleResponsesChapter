...
optimisation unit.  The main difference between the transient chopper types
...
Figure \ref{fig:CT2results} shows the results of the \ChT2 TS cell model optimisation.  
The
