...
recorded neurotransmitter blockers strychnine and bicuculine, which directly
...
responses.  The sound level units (dB Attn.) were referenced from an acoustic
...
DCN units in Figures \ref{fig:SpirouFig1}B and C also showed strong suppression
...
# RL Error = 149.797
# NRL Error = 6.8213
# RL without DS Error   = 97.4042
# NRL without DS Error = 61.6979
# RL wo GLG Error = 181.375
# NRL wo GLG Error = 109.893
# Final error = 606.988
