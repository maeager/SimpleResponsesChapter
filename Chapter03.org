...
\yellownote{CV statistics results in TS cells} [Spiking measures intro]
The
regularity of inter-spike intervals in \TS cells create its typical chopper
\PSTH and is best measured using the coefficient of variation statistic.
