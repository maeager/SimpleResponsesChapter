...
\textbf{Input Stimulus} & Pure tone stimuli with 50 msec duration, 2 msec cosine squared on\slash off ramp, and 20 msec delay. Optimisation of each chopper unit used the CF and 30 dB relative to the threshold sound level of the exemplar unit: CS (3.9~kHz 40 dB SPL), CT1 (8.2 kHz, 85 dB SPL), CT2 (12.4~kHz 35 dB SPL). \\\hline 
     \textbf{Parameters}      & 
      \wHSRTS, \nHSRTS,    
      \wLSRTS, \nLSRTS,   
      \wDSTS,  \nDSTS,   
