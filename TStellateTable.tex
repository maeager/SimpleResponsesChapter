...
\textbf{Input model} & ANF~model: phenomenological instantaneous-rate Poisson model \citep{ZilanyBruce:2007} \\
\multirow{4}{*}{\textbf{Neuron model}} & Golgi: instantaneous-rate Poisson model\\
                                       ...
                                       & Tuberculo-ventral cell:  HH-like single-compartment type 1-c R\&M model \\
