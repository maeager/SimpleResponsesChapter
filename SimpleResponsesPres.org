...
#    #+  LaTeX_header:\usepackage[origletters,vara,varf,varGamma,varPi]{arev}  
#+LaTeX_header:\usepackage{arev} %lucidabr}  %{palatino}
#+   LaTeX_header    :\usepackage{mathpazo} % arevmath} %
...
** Acknowledgements
  ...
  *Computing Facilities*
    - 9 Dual CPU PCs: Dept. Otolaryngolgy
