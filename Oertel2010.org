...
* \citet*{OertelWrightEtAl:2011} The multiple functions of T stellate/multipolar/chopper cells in the ventral cochlear nucleus
...
d. NE and 5HT
  ...
  - both increase firing in T stellates \citep{OertelWrightEtAl:2011} in presence of glut and gly blockers -> hence act on post synapse (TS cells)
